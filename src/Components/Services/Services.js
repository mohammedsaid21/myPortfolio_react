      ...
      <div className="container services_container">
        ...
        <div className="services-cards">
          <div className="services-card">
            ...
            <span onClick={handleShowService}>
              See more <BsArrowRightShort className="services-icon" />
            </span>
            <div className={fixed === "services-card" ? "none-div" : fixed}>
              ...
              <ul>
                <li>
                  <BiCheck />I develop the user Interface
                </li>
                <li>
                  <BiCheck />
                ...
                <li>
                  <BiCheck />
                  Design and mockups of products for componies
                </li>
                <li>
                  <BiCheck />I create ux element interactions
                </li>
              </ul>
            </div>
          </div>
